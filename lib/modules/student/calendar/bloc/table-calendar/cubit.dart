...
class TableCalendarCubit extends Cubit<TableCalendarState> {
  ...
  TableCalendarCubit(this._studentEventsService) : super(TableCalendarInitialState());
  ...
  Future<void> fetchStudentEvents() {
    ...
    DateTime dateSelected = DateTime(todayDate.year, todayDate.month, todayDate.day);
    DateTime dateFrom = DateTime(dateSelected.year, dateSelected.month, FIRST_DAY_OF_MONTH);
    var dateToMonth = dateSelected.month + 1;
    DateTime dateTo = DateTime(dateSelected.year, dateToMonth, FIRST_DAY_OF_MONTH);
